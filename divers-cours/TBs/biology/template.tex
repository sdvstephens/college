...
\title{\Huge{Biology}\\Campbell's Textbook}
\author{\huge{S. D. V. S.}}
\date{}
...
Life follows a human-made hierarchy: from \to  biosphere \to ecosystem \to community \to population \to organism \to organ system \to organ \to tissue \to cell \to organelle \to molecule \to atom.

\\ Each change in a step of the hierarchy results in \textbf{emergent properties}, which are the interactions of higher levels with lower levels (part of \textbf{systems biology}). The most basic unit of life ends at the cell, where the cell is the smallest unit of structure required to perform all necessary functions of life. A cell is either \textbf{Eukaryotic} or \textbf{Prokaryotic}. 

\\ Genetic information within a Eukaryotic cell is contained in the nucleus as \textbf{DNA}. It is this DNA (deoxyribonucleic acid) that is passed down as heritable information from parents to offspring. DNA sequences, called genes, program the cells protein production through a process called gene expression facilitated by mRNA. \textbf{Genomics} is the study and analysis of large-scale genome sequences; similarly, \textbf{bioinformatics} is a field of study which uses computational tools to deal with large volumes of this biological information and data.  
